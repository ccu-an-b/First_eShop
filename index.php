...
<body>
	<div class="header">
			...
			<table class="user">
			<tr>
				<td style="float:right"><?php echo admin_print($_SESSION['logged_on_user']);?></td>
				<td style="width:35%"><a href="<?php connexion_link($_SESSION['logged_on_user']); ?>"><h2><?php connexion_title($_SESSION['logged_on_user']); ?></h2></a></td>
	...
	<div>
	<div class="welcome">
		<div class="welcome_text"><?php whoami($_SESSION['logged_on_user']);?>
		</div>
	</div>
	</div>
	<div class="banner">
	...
	<div class="main">
		<?php echo products_print("Tous nos voyages");?><br/>
	</div>
</body>
</html>
